            ...
            <div className="col-lg-4 col-md-6">
                <div className="blog1-boxarea">
                    ...
                    <div className="blog1-padding">
                        ...
                        <Link  href="#" className="font-lora font-20 lineh-30 weight-600 color-29 margin-b d-inline-block link-hover">Bussiness
                        ...
                        <Link  href="#" className="font-ks font-16 lineh-16 color-29 weight-700  d-inline-block laearnmore2 bloginnerhover">Learn
