                    ...
                    <div className="row">
                        <div className="col-lg-6 m-auto">
                            <div className="client10-header text-center margin-b60">
                                    ...
                                    <span className="about-span font-ks font-16 lineh-16 weight-600 color-ks1">How It
                                    Works</span>
                                <h1 className="font-44 lineh-54 weight-600 colorhp3 font-lora margin-b24s">The Process Of Career
                        ...
                        <div className="row">
                            <div className="col-lg-3" data-aos="zoom-in" data-aos-duration={1000} data-aos-easing="linear">
                                <div className="client10-boxarea text-center">
                                    ...
                                    <Link href="/servicemiddle" className="font-lora font-20 lineh-20 weight-600 colorhp3 ts d-inline-block margin-b">Introduction</Link>
                                    <p className="font-ks font-16 lineh-26 weight-500 color-p10 ts">We help you make informed <br />
                                        choices that align with goals.</p>
                                </div>
                            </div>
                            <div className="col-lg-3" data-aos="zoom-out" data-aos-duration={1200} data-aos-easing="linear">
                                <div className="client10-boxarea text-center positionboxarea">
                                    ...
                                    <Link href="/servicemiddle" className="font-lora font-20 lineh-20 weight-600 colorhp3 ts d-inline-block margin-b">Process
                                        Consulting</Link>
                                    <p className="font-ks font-16 lineh-26 weight-500 color-p10 ts">We help you make informed <br />
                                        choices that align with goals.</p>
                                </div>
                            ...
                            <div className="col-lg-3" data-aos="zoom-in" data-aos-duration={1400} data-aos-easing="linear">
                                <div className="client10-boxarea text-center">
                                    ...
                                    <Link href="/servicemiddle" className="font-lora font-20 lineh-20 weight-600 colorhp3 ts d-inline-block margin-b">Understand
                                        Consulting</Link>
                                    <p className="font-ks font-16 lineh-26 weight-500 color-p10 ts">We help you make informed <br />
                                        choices that align with goals.</p>
                                </div>
                            ...
                            <div className="col-lg-3" data-aos="zoom-in" data-aos-duration={1600} data-aos-easing="linear">
                                <div className="client10-boxarea text-center positionboxarea">
                                    ...
                                    <Link href="/servicemiddle" className="font-lora font-20 lineh-20 weight-600 colorhp3 ts d-inline-block margin-b">Benefits
                                        Of Consulting</Link>
                                    <p className="font-ks font-16 lineh-26 weight-500 color-p10 ts">We help you make informed <br />
                                        choices that align with goals.</p>
                                </div>
