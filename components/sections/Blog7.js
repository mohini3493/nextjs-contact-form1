                    ...
                    <div className="row">
                        <div className="col-lg-6 m-auto">
                            <div className="blog-7-header text-center margin-b60">
                                <h1 className="font-lora font-44 lineh-52 weight-500 color-h7 margin-b20">Our Latest Blog</h1>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration={1200}>
                            <div className=" blog7boxarea">
                                ...
                                <div className=" blog-pdding2">
                                    ...
                                    <Link href="#" className="font-lora font-24 lineh-30 weight-500 color-h7 margin-b d-inline-block link-hover ts">Investment
                                    ...
                                    <Link href="#" className="font-ks font-16 lineh-16 color-ks1 weight-700  d-inline-block laearnmore2 ts">Learn
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration={1000}>
                            <div className=" blog7boxarea">
                                ...
                                <div className=" blog-pdding2">
                                    ...
                                    <Link href="#" className="font-lora font-24 lineh-30 weight-500 color-h7 margin-b d-inline-block link-hover ts">Retirement
                        ...
                        <div className="col-lg-4 col-md-6" data-aos="fade-right" data-aos-duration={800}>
                            <div className=" blog7boxarea">
                                ...
                                <div className=" blog-pdding2">
                                    ...
                                    <Link href="#" className="font-lora font-24 lineh-30 weight-500 color-h7 margin-b d-inline-block link-hover ts">Building
